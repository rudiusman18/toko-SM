...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //   String? numericString = product.product?.productPrice
    //       ?.split(",")[0]
    ...
    //                                 productProvider.cartData.removeWhere(
    //                                     (element) =>
    //                                         element.product!.urlImg ==
    //                                         product.product!.urlImg);
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            paymentTotalItem(
                title: "Ongkos Kirim",
                value: "Rp ${currencyFormatter.format(10000)}",
                bottomMargin: 10),
            paymentTotalItem(
                title: "Total Harga",
      ...
      return Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            productProvider.cartData.isEmpty
                ? const SizedBox()
                : Align(
                    ...
                    productProvider.cartData.isEmpty
                        ...
                        : ListView(
                            children: [
                              ...
                              for (var i = 0;
                                  i < productProvider.cartData.length;
                                  i++)
